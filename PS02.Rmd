...
train <- read_csv("~/Desktop/Amherst Academic/Stat 495/Ps2/data/train.csv")
test <- read_csv("~/Desktop/Amherst Academic/Stat 495/Ps2/data/test.csv")
macro <- read_csv("~/Desktop/Amherst Academic/Stat 495/Ps2/data/macro.csv")
sample_submission <- read_csv("~/Desktop/Amherst Academic/Stat 495/Ps2/data/sample_submission.csv")
...
RMSE train  0.002997109. Note, this is using a logged scale. 
...
The RMSE for this is 0.42257 as per Kaggle.
...
The RMSE's are similar (and higher than the one computed through the full training set).
...
The RMSE for this is slightly higher at 2.14868 as per Kaggle.
